...
print(ztable(mytable(sex~.,data=d_gender_t))) #table_1  gender table
```

### Histology table
```{r, echo=TRUE, message=FALSE}
d_hist_t<-d[c("age", "location", "hist_group","size" )]
print(ztable(mytable(hist_group~., data=d_hist_t))) #table_2 histology table
# summary(aov(size~hist_group, data=d)) same result with chi-squire table analysis.
```

### location table
```{r, echo=TRUE, message=FALSE}
print(ztable(mytable(location~., data = d_gender_t)))
```
